...
void EQLNES_RTC::setDateTime(int day, int month, int year, int hours, int minutes, int seconds)
{
...
String EQLNES_RTC::readDateTimeAsText()
{
...
time_t EQLNES_RTC::readDateTime()
{
    int timedate[7];
    for (int i = 0; i <= 6; ++i)
    {
