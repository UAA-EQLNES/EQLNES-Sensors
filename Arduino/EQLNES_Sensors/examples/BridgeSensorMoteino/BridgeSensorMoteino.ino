/*
  ...
  This sketch generates random sensor readings instead of relying
  on Ultrasonic sensor and thermistor.
...
// EQLNES Sensors SDCard Dependency
#include <SdFat.h>
#include <String.h>

// EQLNES Sensors RTC Dependency
#include <SPI.h>
#include <Time.h>
