/*
  ...
  Sketch used by EQLNES Sensors platform.
...
#include <EQLNES_RTC.h>


// EQLNES SDCard Dependency
#include <SdFat.h>
#include <String.h>

// EQLNES RTC Dependency
#include <SPI.h>
#include <Time.h>
...
EQLNES_Sim900 sim900;
EQLNES_RTC rtc(RTC_CS_PIN);
EQLNES_SDCard sd(SD_CS_PIN);
